...
<section class="blog-list py-5 ">
            ...
            @foreach($list_post as $list)
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="{{$list->image}}" height="400px" width="400px" alt="image">
					    <div class="media-body">
						    <h3 class="title mb-1">{{$list->title}}</h3>
						    <div class="intro">{{$list->short_des}} </div>
						    <a class="more-link" href="detail/{{$list->id}}">Read more &rarr;</a>
					    </div><!--//media-body-->
				    </div><!--//media-->
			    </div><!--//item-->
              @endforeach
