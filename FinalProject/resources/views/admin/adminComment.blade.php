			...
			<table class="table table-striped table-hover">
			 ...
			 @foreach($list_comment as $list)
					<tr>
						...
						<td>{{ $list ->content}}</td>
						<td>
							<a href="editComment/{{$list->id}}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
							<a href="deleteComment/{{$list->id}}" class="delete" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="post" action="{{route('gc')}}">
			@csrf
